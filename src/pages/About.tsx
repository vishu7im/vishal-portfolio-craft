              ...
              <ScrollReveal threshold={0.3} delay={300}>
                <div>
                  ...
                  <p className="text-foreground/90 mb-6 leading-relaxed">
                    {profile.bio} I'm passionate about building high-performance, maintainable backend systems that solve real-world problems. 
                    With expertise in Node.js and database design, I focus on creating reliable and secure APIs that 
                    power exceptional user experiences.
                  </p>
                  
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="bg-card/80 backdrop-blur-sm p-4 rounded-lg shadow-md tilt-card">
                      <h3 className="font-semibold text-foreground mb-2 animated-border inline-block">Location</h3>
                      <p className="text-muted-foreground">{profile.location}</p>
                    </div>
                    <div className="bg-card/80 backdrop-blur-sm p-4 rounded-lg shadow-md tilt-card">
                      <h3 className="font-semibold text-foreground mb-2 animated-border inline-block">Experience</h3>
                      <p className="text-muted-foreground">{profile.experience}</p>
                    </div>
                    <div className="bg-card/80 backdrop-blur-sm p-4 rounded-lg shadow-md tilt-card">
                      <h3 className="font-semibold text-foreground mb-2 animated-border inline-block">Email</h3>
                      <p className="text-muted-foreground">{profile.email}</p>
                    </div>
                    <div className="bg-card/80 backdrop-blur-sm p-4 rounded-lg shadow-md tilt-card">
                      <h3 className="font-semibold text-foreground mb-2 animated-border inline-block">Phone</h3>
