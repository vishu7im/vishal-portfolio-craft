...
const ProjectsSection: React.FC = () => {
  ...
  return (
    <section className="bg-navy-50 py-16 relative overflow-hidden">
      {/* Background elements */}
      ...
      <div className="section-container relative z-10">
              ...
              <Card className="card-hover tilt-card flex flex-col h-full border-none shadow-lg overflow-hidden">
                ...
                <CardFooter className="flex justify-between">
                  {project.github && (
                    ...
                    >
                      <Github size={16} className="transition-transform duration-200 group-hover:rotate-12" /> Code
                    </a>
                  )}
                  {project.demo && (
                    <a 
                      ...
                      className="flex items-center gap-1 text-navy-700 hover:text-primary transition-colors group"
                    >
                      <ExternalLink size={16} className="transition-transform duration-200 group-hover:translate-x-1 group-hover:-translate-y-1" /> Live Demo
                    </a>
                  )}
                </CardFooter>
              </Card>
        ...
        <div className="text-center mt-12">
          <ScrollReveal threshold={0.5} delay={600}>
            <Link to="/projects">
              <Button variant="outline" className="btn-outline group overflow-hidden relative">
