      ...
      <div className="section-container relative z-10">
        <ScrollReveal>
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 gradient-text">Ready to Build Something Amazing?</h2>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a href="https://github.com/vishal" target="_blank" rel="noopener noreferrer">
                <Button variant="outline" className="btn-outline text-lg py-6 px-8 relative group overflow-hidden">
                  <span className="relative z-10 group-hover:text-white transition-colors duration-300">View Github</span>
