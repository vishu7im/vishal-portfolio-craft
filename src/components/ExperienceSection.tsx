  ...
  return (
    <section className="bg-white py-16 relative overflow-hidden">
      ...
      <div className="section-container relative z-10">
        <ScrollReveal>
          <h2 className="section-title text-center gradient-text">Work Experience</h2>
          ...
          {experiences.map((exp, index) => (
            <ScrollReveal key={exp.id} threshold={0.1} delay={index * 200}>
              <div className="mb-8 relative">
                ...
                <Card className="card-hover tilt-card relative z-10 border-none shadow-lg overflow-hidden">
                  <CardHeader className="flex flex-row items-start gap-4">
                    ...
                    <div className="flex-grow">
                      <div className="flex flex-wrap justify-between items-start">
                        <div>
                          <CardTitle className="gradient-text">{exp.position}</CardTitle>
                          <CardDescription className="text-base mt-1 font-medium">{exp.company}</CardDescription>
                        </div>
